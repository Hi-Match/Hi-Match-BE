...
import kr.co.himatch.thanksyouplz.auth.jwt.JsonWebTokenCheckFilter;
import kr.co.himatch.thanksyouplz.auth.jwt.JsonWebTokenProvider;
import kr.co.himatch.thanksyouplz.auth.oauth.CustomOAuth2Provider;
import kr.co.himatch.thanksyouplz.auth.preferences.*;
...
import static kr.co.himatch.thanksyouplz.auth.Constants.*;
...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers(PathRequest.toStaticResources().atCommonLocations())
                .requestMatchers(SECURITY_HTTP_EXCLUDE_URIS);
    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "https://localhost:5173", "https://www.himatch.co.kr", "https://himatch.co.kr", "http://www.himatch.co.kr", "http://himatch.co.kr"));
...
//        configuration.setAllowedOriginPatterns(Collections.singletonList("http://localhost:3009"));
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:5173", "https://localhost:5173", "https://www.himatch.co.kr", "https://himatch.co.kr", "http://www.himatch.co.kr", "http://himatch.co.kr"));
...
//        http.cors().configurationSource(corsConfigurationSource());
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                                .requestMatchers(SECURITY_HTTP_EXCLUDE_URIS).permitAll()                            //(0)[Constants] SECURITY_HTTP_EXCLUDE_URIS 권한 허용
