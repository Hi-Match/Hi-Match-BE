package kr.co.himatch.thanksyouplz.auth.oauth;
...
import static kr.co.himatch.thanksyouplz.auth.Constants.SERVER_URL;
...
public enum CustomOAuth2Provider {
    ...
    KAKAO {
        ...
        public Builder getBuilder(String registrationId) {
            Builder builder = getBuilder(registrationId,
                    ClientAuthenticationMethod.CLIENT_SECRET_POST, SERVER_URL.concat("/himatch/member/login/callback/{registrationId}"));
    ...
    GOOGLE {
        ...
        public Builder getBuilder(String registrationId) {
            Builder builder = getBuilder(registrationId,
                    ClientAuthenticationMethod.CLIENT_SECRET_BASIC, SERVER_URL.concat("/himatch/member/login/callback/{registrationId}"));
