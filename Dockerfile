...
RUN python3 -c "from transformers import AutoTokenizer, AutoModel; AutoModel.from_pretrained('jhgan/ko-sroberta-multitask'); AutoTokenizer.from_pretrained('jhgan/ko-sroberta-multitask')"
